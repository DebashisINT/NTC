package com.trackerbreeze.features.permissionList
...
import com.trackerbreeze.test.viewPermission.AdapterViewPermission
        ...
        for(i in 0..list.size-1){
            if(list1.get(i)!="android.permission.ACCESS_GPS") {
                var obj: PermissionDetails = PermissionDetails(list1.get(i).replace("android.permission.", "").replace("_", " ")
                        ...
                        replace("com.trackerbreeze.permission.C2D",""), list.get(i))
