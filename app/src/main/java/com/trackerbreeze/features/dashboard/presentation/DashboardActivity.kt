...
import com.trackerbreeze.*
import com.trackerbreeze.R
import com.trackerbreeze.app.*
import com.trackerbreeze.app.NewFileUtils.browseDocuments
import com.trackerbreeze.app.NewFileUtils.browsePDFDocuments
import com.trackerbreeze.app.NewFileUtils.getExtension
import com.trackerbreeze.app.domain.*
import com.trackerbreeze.app.types.DashboardType
import com.trackerbreeze.app.types.FragType
import com.trackerbreeze.app.types.TopBarConfig
import com.trackerbreeze.app.uiaction.DisplayAlert
import com.trackerbreeze.app.utils.*
import com.trackerbreeze.app.utils.AppUtils.Companion.isProfile
...
import com.trackerbreeze.features.NewQuotation.*
import com.trackerbreeze.features.NewQuotation.api.GetQuotRegProvider
import com.trackerbreeze.features.NewQuotation.model.ViewDetailsQuotResponse
import com.trackerbreeze.features.SearchLocation.SearchLocationFragment
import com.trackerbreeze.features.SearchLocation.locationInfoModel
import com.trackerbreeze.features.TA.ViewAllTAListFragment
import com.trackerbreeze.features.achievement.AchievementFragment
import com.trackerbreeze.features.activities.presentation.*
import com.trackerbreeze.features.addAttendence.*
import com.trackerbreeze.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.trackerbreeze.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.trackerbreeze.features.addAttendence.model.GetReportToFCMResponse
import com.trackerbreeze.features.addAttendence.model.GetReportToResponse
import com.trackerbreeze.features.addAttendence.model.Leave_list_Response
import com.trackerbreeze.features.addorder.presentation.AddOrderFragment
...
import com.trackerbreeze.features.addshop.presentation.AddShopFragment
import com.trackerbreeze.features.addshop.presentation.OTPVerificationDialog
import com.trackerbreeze.features.addshop.presentation.ScanImageFragment
import com.trackerbreeze.features.addshop.presentation.ShowCardDetailsDialog
import com.trackerbreeze.features.alarm.model.AlarmData
import com.trackerbreeze.features.alarm.presetation.AttendanceReportFragment
import com.trackerbreeze.features.alarm.presetation.PerformanceReportFragment
import com.trackerbreeze.features.alarm.presetation.VisitReportDetailsFragment
import com.trackerbreeze.features.alarm.presetation.VisitReportFragment
import com.trackerbreeze.features.attendance.AttendanceFragment
import com.trackerbreeze.features.attendance.api.AttendanceRepositoryProvider
import com.trackerbreeze.features.attendance.model.AttendanceRequest
import com.trackerbreeze.features.attendance.model.AttendanceResponse
import com.trackerbreeze.features.averageshop.presentation.AverageShopFragment
import com.trackerbreeze.features.avgorder.presentation.AverageOrderFragment
import com.trackerbreeze.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.trackerbreeze.features.beatCustom.TeamBeatListFragment
import com.trackerbreeze.features.billing.presentation.AddBillingFragment
import com.trackerbreeze.features.billing.presentation.BillingDetailsFragment
import com.trackerbreeze.features.billing.presentation.BillingListFragment
import com.trackerbreeze.features.changepassword.presentation.ChangePasswordDialog
import com.trackerbreeze.features.chat.model.ChatListDataModel
import com.trackerbreeze.features.chat.model.ChatUserDataModel
import com.trackerbreeze.features.chat.model.GroupUserDataModel
import com.trackerbreeze.features.chat.presentation.*
import com.trackerbreeze.features.chatbot.presentation.ChatBotFragment
import com.trackerbreeze.features.chatbot.presentation.ChatBotShopListFragment
import com.trackerbreeze.features.chatbot.presentation.ReportsFragment
import com.trackerbreeze.features.chatbot.presentation.SelectLanguageDialog
import com.trackerbreeze.features.commondialog.presentation.CommonDialog
import com.trackerbreeze.features.commondialog.presentation.CommonDialogClickListener
import com.trackerbreeze.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.trackerbreeze.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.trackerbreeze.features.contacts.ActivityDtlsFrag
import com.trackerbreeze.features.contacts.AddOpptFrag
import com.trackerbreeze.features.contacts.ContactDtls
import com.trackerbreeze.features.contacts.ContactGr
import com.trackerbreeze.features.contacts.ContactsAddFrag
import com.trackerbreeze.features.contacts.ContactsFrag
import com.trackerbreeze.features.contacts.SchedulerAddFormFrag
import com.trackerbreeze.features.contacts.SchedulerViewFrag
import com.trackerbreeze.features.contacts.TemplateAddFrag
import com.trackerbreeze.features.contacts.TemplateViewFrag
import com.trackerbreeze.features.contacts.ViewCrmOpptFrag
import com.trackerbreeze.features.dailyPlan.prsentation.AllShopListFragment
import com.trackerbreeze.features.dailyPlan.prsentation.DailyPlanListFragment
import com.trackerbreeze.features.dailyPlan.prsentation.PlanDetailsFragment
import com.trackerbreeze.features.damageProduct.ShopDamageProductListFrag
import com.trackerbreeze.features.damageProduct.ShopDamageProductSubmitFrag
import com.trackerbreeze.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.trackerbreeze.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.trackerbreeze.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.trackerbreeze.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.trackerbreeze.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.trackerbreeze.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.trackerbreeze.features.dashboard.presentation.model.ContentListResponseModel
import com.trackerbreeze.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.trackerbreeze.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.trackerbreeze.features.device_info.presentation.DeviceInfoListFragment
import com.trackerbreeze.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.trackerbreeze.features.document.DocumentRepoFeatureNewFragment
import com.trackerbreeze.features.document.presentation.DocumentListFragment
import com.trackerbreeze.features.document.presentation.DocumentTypeListFragment
import com.trackerbreeze.features.document.presentation.OpenFileWebViewFragment
import com.trackerbreeze.features.dymanicSection.presentation.AddDynamicFragment
import com.trackerbreeze.features.dymanicSection.presentation.AllDynamicListFragment
import com.trackerbreeze.features.dymanicSection.presentation.DynamicListFragment
import com.trackerbreeze.features.dymanicSection.presentation.EditDynamicFragment
import com.trackerbreeze.features.gpsDisabilityScreen.GpsDisableFragment
import com.trackerbreeze.features.home.presentation.HomeFragment
import com.trackerbreeze.features.homelocation.presentation.HomeLocationFragment
import com.trackerbreeze.features.homelocation.presentation.HomeLocationMapFragment
import com.trackerbreeze.features.know_your_state.KnowYourStateFragment
import com.trackerbreeze.features.lead.LeadFrag
import com.trackerbreeze.features.lead.ViewLeadFrag
import com.trackerbreeze.features.leaderboard.LeaderBoardFrag
import com.trackerbreeze.features.leaveapplynew.LeaveHome
import com.trackerbreeze.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.trackerbreeze.features.localshops.LocalShopListFragment
import com.trackerbreeze.features.localshops.LocalShopListMapFragment
import com.trackerbreeze.features.localshops.NearByShopsMapFragment
import com.trackerbreeze.features.location.*
import com.trackerbreeze.features.location.api.LocationRepoProvider
import com.trackerbreeze.features.location.model.*
import com.trackerbreeze.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.trackerbreeze.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.trackerbreeze.features.login.ShopFeedbackEntity
import com.trackerbreeze.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.trackerbreeze.features.login.presentation.LoginActivity
import com.trackerbreeze.features.logout.presentation.api.LogoutRepositoryProvider
import com.trackerbreeze.features.logoutsync.presentation.LogoutSyncFragment
import com.trackerbreeze.features.marketAssist.MarketAssistTabFrag
import com.trackerbreeze.features.marketAssist.ShopDtlsMarketAssistFrag
import com.trackerbreeze.features.marketAssist.ShopListMarketAssistFrag
import com.trackerbreeze.features.marketing.presentation.MarketingPagerFragment
import com.trackerbreeze.features.meetinglist.prsentation.MeetingListFragment
import com.trackerbreeze.features.member.MapViewForTeamFrag
import com.trackerbreeze.features.member.model.TeamLocDataModel
import com.trackerbreeze.features.member.model.TeamShopListDataModel
import com.trackerbreeze.features.member.presentation.*
import com.trackerbreeze.features.menuBeat.MenuBeatFrag
import com.trackerbreeze.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.trackerbreeze.features.micro_learning.presentation.MicroLearningListFragment
import com.trackerbreeze.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.trackerbreeze.features.myallowancerequest.MyallowanceRequestFragment
import com.trackerbreeze.features.myjobs.model.CustomerDataModel
import com.trackerbreeze.features.myjobs.presentation.*
import com.trackerbreeze.features.mylearning.MyLearningFragment
import com.trackerbreeze.features.myorder.presentation.MyOrderListFragment
import com.trackerbreeze.features.myprofile.presentation.MyProfileFragment
...
import com.trackerbreeze.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.trackerbreeze.features.nearbyshops.presentation.BeatListFragment
import com.trackerbreeze.features.nearbyshops.presentation.NearByShopsListFragment
import com.trackerbreeze.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.trackerbreeze.features.nearbyshops.presentation.ShopCallHisFrag
import com.trackerbreeze.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.trackerbreeze.features.newcollection.CollectionDetailsStatusFragment
import com.trackerbreeze.features.newcollection.CollectionShopListFragment
import com.trackerbreeze.features.newcollection.NewCollectionListFragment
import com.trackerbreeze.features.newcollectionreport.*
import com.trackerbreeze.features.notification.NotificationFragment
import com.trackerbreeze.features.orderITC.CartListFrag
import com.trackerbreeze.features.orderITC.OrderListFrag
import com.trackerbreeze.features.orderITC.ProductListFrag
import com.trackerbreeze.features.orderITC.ViewNewOrdHisAllFrag
import com.trackerbreeze.features.orderITC.ViewNewOrdHistoryFrag
import com.trackerbreeze.features.orderITC.ViewOrdDtls
import com.trackerbreeze.features.orderList.NewDateWiseOrderListFragment
import com.trackerbreeze.features.orderList.NewOrderListFragment
import com.trackerbreeze.features.orderList.OrderListFragment
import com.trackerbreeze.features.orderdetail.presentation.OrderDetailFragment
import com.trackerbreeze.features.orderhistory.ActivityMapFragment
import com.trackerbreeze.features.orderhistory.OrderhistoryFragment
import com.trackerbreeze.features.orderhistory.TimeLineFragment
...
import com.trackerbreeze.features.orderhistory.model.FetchLocationResponse
import com.trackerbreeze.features.orderhistory.model.LocationData
import com.trackerbreeze.features.pendinglocationinout.PendingOutLocationFrag
import com.trackerbreeze.features.performance.GpsStatusFragment
import com.trackerbreeze.features.performance.PerformanceFragment
import com.trackerbreeze.features.performance.api.UpdateGpsStatusRepoProvider
import com.trackerbreeze.features.performance.model.UpdateGpsInputParamsModel
import com.trackerbreeze.features.performanceAPP.OwnPerformanceFragment
import com.trackerbreeze.features.performanceAPP.PerformanceAppFragment
import com.trackerbreeze.features.performanceAPP.allPerformanceFrag
import com.trackerbreeze.features.permissionList.ViewPermissionFragment
import com.trackerbreeze.features.photoReg.*
import com.trackerbreeze.features.privacypolicy.PrivacypolicyWebviewFrag
import com.trackerbreeze.features.quotation.presentation.*
import com.trackerbreeze.features.reimbursement.presentation.*
import com.trackerbreeze.features.report.presentation.*
import com.trackerbreeze.features.returnsOrder.*
import com.trackerbreeze.features.settings.presentation.SettingsFragment
import com.trackerbreeze.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.trackerbreeze.features.shopdetail.presentation.*
import com.trackerbreeze.features.shopdetail.presentation.api.EditShopRepoProvider
import com.trackerbreeze.features.stock.StockDetailsFragment
import com.trackerbreeze.features.stock.StockListFragment
import com.trackerbreeze.features.stockAddCurrentStock.AddShopStockFragment
import com.trackerbreeze.features.stockAddCurrentStock.UpdateShopStockFragment
import com.trackerbreeze.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.trackerbreeze.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.trackerbreeze.features.stockCompetetorStock.AddCompetetorStockFragment
import com.trackerbreeze.features.stockCompetetorStock.CompetetorStockFragment
import com.trackerbreeze.features.stockCompetetorStock.ViewComStockProductDetails
import com.trackerbreeze.features.survey.SurveyFrag
import com.trackerbreeze.features.survey.SurveyViewDtlsFrag
import com.trackerbreeze.features.survey.SurveyViewFrag
import com.trackerbreeze.features.task.presentation.AddTaskFragment
import com.trackerbreeze.features.task.presentation.CalenderTaskFragment
import com.trackerbreeze.features.task.presentation.EditTaskFragment
import com.trackerbreeze.features.task.presentation.TaskListFragment
import com.trackerbreeze.features.taskManagement.TaskManagementFrag
import com.trackerbreeze.features.taskManagement.ViewTaskManagementFrag
import com.trackerbreeze.features.timesheet.presentation.AddTimeSheetFragment
import com.trackerbreeze.features.timesheet.presentation.EditTimeSheetFragment
import com.trackerbreeze.features.timesheet.presentation.TimeSheetListFragment
import com.trackerbreeze.features.viewAllOrder.CartFragment
import com.trackerbreeze.features.viewAllOrder.OrderTypeListFragment
import com.trackerbreeze.features.viewAllOrder.ViewAllOrderListFragment
import com.trackerbreeze.features.viewAllOrder.ViewCartFragment
import com.trackerbreeze.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.trackerbreeze.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.trackerbreeze.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.trackerbreeze.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.trackerbreeze.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.trackerbreeze.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.trackerbreeze.features.viewPPDDStock.ViewOutstandingFragment
import com.trackerbreeze.features.viewPPDDStock.ViewPPDDListFragment
import com.trackerbreeze.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.trackerbreeze.features.viewPPDDStock.ViewStockFragment
import com.trackerbreeze.features.weather.presentation.WeatherFragment
import com.trackerbreeze.mappackage.MapActivity
import com.trackerbreeze.mappackage.MapActivityWithoutPath
import com.trackerbreeze.mappackage.SendBrod
...
import com.trackerbreeze.features.mylearning.KnowledgeHubAllVideoList
import com.trackerbreeze.features.mylearning.LeaderboardLmsFrag
import com.trackerbreeze.features.mylearning.MyLearningAllVideoList
import com.trackerbreeze.features.mylearning.SearchLmsFrag
import com.trackerbreeze.features.mylearning.SearchLmsKnowledgeFrag
import com.trackerbreeze.features.mylearning.SearchLmsLearningFrag
import com.trackerbreeze.features.mylearning.VideoPlayLMS
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xtrackerbreezelogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xtrackerbreezelogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.trackerbreeze/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xtrackerbreezelogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xtrackerbreezelogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xtrackerbreezelogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xtrackerbreezelogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
