package com.trackerbreeze.features.logoutsync.presentation
...
import com.trackerbreeze.CustomConstants
...
import com.trackerbreeze.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.trackerbreeze.features.billing.api.AddBillingRepoProvider
import com.trackerbreeze.features.billing.model.AddBillingInputParamsModel
...
import com.trackerbreeze.features.dashboard.presentation.ReasonDialog
...
import com.trackerbreeze.features.document.model.AddEditDocumentInputParams
import com.trackerbreeze.features.document.model.DocumentAttachmentModel
...
import com.trackerbreeze.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.trackerbreeze.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.trackerbreeze.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.trackerbreeze.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.trackerbreeze.features.orderhistory.model.*
...
import com.trackerbreeze.features.quotation.model.AddQuotInputModel
import com.trackerbreeze.features.shopdetail.presentation.api.EditShopRepoProvider
import com.trackerbreeze.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.trackerbreeze.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.trackerbreeze.features.stock.api.StockRepositoryProvider
import com.trackerbreeze.features.stock.model.AddStockInputParamsModel
import com.trackerbreeze.features.stockAddCurrentStock.AddShopStockFragment
import com.trackerbreeze.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.trackerbreeze.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.trackerbreeze.features.timesheet.model.AddTimeSheetInputModel
import com.trackerbreeze.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.trackerbreeze.features.viewAllOrder.model.AddOrderInputParamsModel
...
import com.trackerbreeze.features.performance.model.UpdateGpsInputListParamsModel
import com.trackerbreeze.features.returnsOrder.ReturnProductList
import com.trackerbreeze.features.returnsOrder.ReturnRequest
import com.trackerbreeze.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xtrackerbreezelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xtrackerbreezelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xtrackerbreezelogsample/log.zip").path);
