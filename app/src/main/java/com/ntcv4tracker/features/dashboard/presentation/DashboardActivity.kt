package com.ntcv4tracker.features.dashboard.presentation
...
import com.ntcv4tracker.*
import com.ntcv4tracker.R
import com.ntcv4tracker.app.*
import com.ntcv4tracker.app.NewFileUtils.browseDocuments
import com.ntcv4tracker.app.NewFileUtils.browsePDFDocuments
import com.ntcv4tracker.app.NewFileUtils.getExtension
import com.ntcv4tracker.app.domain.*
import com.ntcv4tracker.app.types.DashboardType
import com.ntcv4tracker.app.types.FragType
import com.ntcv4tracker.app.types.TopBarConfig
import com.ntcv4tracker.app.uiaction.DisplayAlert
import com.ntcv4tracker.app.utils.*
import com.ntcv4tracker.app.utils.AppUtils.Companion.isProfile
...
import com.ntcv4tracker.features.NewQuotation.*
import com.ntcv4tracker.features.NewQuotation.api.GetQuotRegProvider
import com.ntcv4tracker.features.NewQuotation.model.ViewDetailsQuotResponse
import com.ntcv4tracker.features.SearchLocation.SearchLocationFragment
import com.ntcv4tracker.features.SearchLocation.locationInfoModel
import com.ntcv4tracker.features.TA.ViewAllTAListFragment
import com.ntcv4tracker.features.achievement.AchievementFragment
import com.ntcv4tracker.features.activities.presentation.*
import com.ntcv4tracker.features.addAttendence.*
import com.ntcv4tracker.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.ntcv4tracker.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.ntcv4tracker.features.addAttendence.model.GetReportToFCMResponse
import com.ntcv4tracker.features.addAttendence.model.GetReportToResponse
import com.ntcv4tracker.features.addAttendence.model.Leave_list_Response
import com.ntcv4tracker.features.addorder.presentation.AddOrderFragment
...
import com.ntcv4tracker.features.addshop.presentation.AddShopFragment
import com.ntcv4tracker.features.addshop.presentation.OTPVerificationDialog
import com.ntcv4tracker.features.addshop.presentation.ScanImageFragment
import com.ntcv4tracker.features.addshop.presentation.ShowCardDetailsDialog
import com.ntcv4tracker.features.alarm.model.AlarmData
import com.ntcv4tracker.features.alarm.presetation.AttendanceReportFragment
import com.ntcv4tracker.features.alarm.presetation.PerformanceReportFragment
import com.ntcv4tracker.features.alarm.presetation.VisitReportDetailsFragment
import com.ntcv4tracker.features.alarm.presetation.VisitReportFragment
import com.ntcv4tracker.features.attendance.AttendanceFragment
...
import com.ntcv4tracker.features.averageshop.presentation.AverageShopFragment
import com.ntcv4tracker.features.avgorder.presentation.AverageOrderFragment
import com.ntcv4tracker.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.ntcv4tracker.features.beatCustom.TeamBeatListFragment
import com.ntcv4tracker.features.billing.presentation.AddBillingFragment
import com.ntcv4tracker.features.billing.presentation.BillingDetailsFragment
import com.ntcv4tracker.features.billing.presentation.BillingListFragment
import com.ntcv4tracker.features.changepassword.presentation.ChangePasswordDialog
import com.ntcv4tracker.features.chat.model.ChatListDataModel
import com.ntcv4tracker.features.chat.model.ChatUserDataModel
import com.ntcv4tracker.features.chat.model.GroupUserDataModel
import com.ntcv4tracker.features.chat.presentation.*
import com.ntcv4tracker.features.chatbot.presentation.ChatBotFragment
import com.ntcv4tracker.features.chatbot.presentation.ChatBotShopListFragment
import com.ntcv4tracker.features.chatbot.presentation.ReportsFragment
import com.ntcv4tracker.features.chatbot.presentation.SelectLanguageDialog
...
import com.ntcv4tracker.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.ntcv4tracker.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.ntcv4tracker.features.contacts.ContactDtls
import com.ntcv4tracker.features.contacts.ContactGr
import com.ntcv4tracker.features.contacts.ContactMasterRes
import com.ntcv4tracker.features.contacts.ContactsAddFrag
import com.ntcv4tracker.features.contacts.ContactsFrag
import com.ntcv4tracker.features.contacts.SchedulerViewFrag
import com.ntcv4tracker.features.contacts.SchedulerAddFormFrag
import com.ntcv4tracker.features.contacts.TypeMasterRes
import com.ntcv4tracker.features.dailyPlan.prsentation.AllShopListFragment
import com.ntcv4tracker.features.dailyPlan.prsentation.DailyPlanListFragment
import com.ntcv4tracker.features.dailyPlan.prsentation.PlanDetailsFragment
import com.ntcv4tracker.features.damageProduct.ShopDamageProductListFrag
import com.ntcv4tracker.features.damageProduct.ShopDamageProductSubmitFrag
import com.ntcv4tracker.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.ntcv4tracker.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.ntcv4tracker.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.ntcv4tracker.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.ntcv4tracker.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
...
import com.ntcv4tracker.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.ntcv4tracker.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.ntcv4tracker.features.device_info.presentation.DeviceInfoListFragment
import com.ntcv4tracker.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.ntcv4tracker.features.document.DocumentRepoFeatureNewFragment
import com.ntcv4tracker.features.document.presentation.DocumentListFragment
import com.ntcv4tracker.features.document.presentation.DocumentTypeListFragment
import com.ntcv4tracker.features.document.presentation.OpenFileWebViewFragment
import com.ntcv4tracker.features.dymanicSection.presentation.AddDynamicFragment
import com.ntcv4tracker.features.dymanicSection.presentation.AllDynamicListFragment
import com.ntcv4tracker.features.dymanicSection.presentation.DynamicListFragment
import com.ntcv4tracker.features.dymanicSection.presentation.EditDynamicFragment
import com.ntcv4tracker.features.gpsDisabilityScreen.GpsDisableFragment
import com.ntcv4tracker.features.home.presentation.HomeFragment
import com.ntcv4tracker.features.homelocation.presentation.HomeLocationFragment
import com.ntcv4tracker.features.homelocation.presentation.HomeLocationMapFragment
import com.ntcv4tracker.features.know_your_state.KnowYourStateFragment
import com.ntcv4tracker.features.lead.LeadFrag
import com.ntcv4tracker.features.lead.ViewLeadFrag
import com.ntcv4tracker.features.leaveapplynew.LeaveHome
import com.ntcv4tracker.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.ntcv4tracker.features.localshops.LocalShopListFragment
import com.ntcv4tracker.features.localshops.LocalShopListMapFragment
import com.ntcv4tracker.features.localshops.NearByShopsMapFragment
import com.ntcv4tracker.features.location.*
import com.ntcv4tracker.features.location.api.LocationRepoProvider
import com.ntcv4tracker.features.location.model.*
import com.ntcv4tracker.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.ntcv4tracker.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.ntcv4tracker.features.login.ShopFeedbackEntity
import com.ntcv4tracker.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.ntcv4tracker.features.login.presentation.LoginActivity
import com.ntcv4tracker.features.logout.presentation.api.LogoutRepositoryProvider
import com.ntcv4tracker.features.logoutsync.presentation.LogoutSyncFragment
import com.ntcv4tracker.features.marketAssist.MarketAssistTabFrag
import com.ntcv4tracker.features.marketAssist.ShopDtlsMarketAssistFrag
import com.ntcv4tracker.features.marketAssist.ShopListMarketAssistFrag
import com.ntcv4tracker.features.marketing.presentation.MarketingPagerFragment
import com.ntcv4tracker.features.meetinglist.prsentation.MeetingListFragment
import com.ntcv4tracker.features.member.MapViewForTeamFrag
import com.ntcv4tracker.features.member.model.TeamLocDataModel
import com.ntcv4tracker.features.member.model.TeamShopListDataModel
import com.ntcv4tracker.features.member.presentation.*
import com.ntcv4tracker.features.menuBeat.MenuBeatFrag
import com.ntcv4tracker.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.ntcv4tracker.features.micro_learning.presentation.MicroLearningListFragment
import com.ntcv4tracker.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.ntcv4tracker.features.myallowancerequest.MyallowanceRequestFragment
import com.ntcv4tracker.features.myjobs.model.CustomerDataModel
import com.ntcv4tracker.features.myjobs.presentation.*
import com.ntcv4tracker.features.myorder.presentation.MyOrderListFragment
import com.ntcv4tracker.features.myprofile.presentation.MyProfileFragment
...
import com.ntcv4tracker.features.nearbyshops.model.ShopListResponse
import com.ntcv4tracker.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.ntcv4tracker.features.nearbyshops.presentation.BeatListFragment
import com.ntcv4tracker.features.nearbyshops.presentation.NearByShopsListFragment
import com.ntcv4tracker.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.ntcv4tracker.features.nearbyshops.presentation.ShopCallHisFrag
import com.ntcv4tracker.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.ntcv4tracker.features.newcollection.CollectionDetailsStatusFragment
import com.ntcv4tracker.features.newcollection.CollectionShopListFragment
import com.ntcv4tracker.features.newcollection.NewCollectionListFragment
import com.ntcv4tracker.features.newcollectionreport.*
import com.ntcv4tracker.features.notification.NotificationFragment
import com.ntcv4tracker.features.orderList.NewDateWiseOrderListFragment
import com.ntcv4tracker.features.orderList.NewOrderListFragment
import com.ntcv4tracker.features.orderList.OrderListFragment
import com.ntcv4tracker.features.orderdetail.presentation.OrderDetailFragment
import com.ntcv4tracker.features.orderhistory.ActivityMapFragment
import com.ntcv4tracker.features.orderhistory.OrderhistoryFragment
import com.ntcv4tracker.features.orderhistory.TimeLineFragment
import com.ntcv4tracker.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.ntcv4tracker.features.orderhistory.model.FetchLocationRequest
import com.ntcv4tracker.features.orderhistory.model.FetchLocationResponse
import com.ntcv4tracker.features.orderhistory.model.LocationData
import com.ntcv4tracker.features.pendinglocationinout.PendingOutLocationFrag
import com.ntcv4tracker.features.performance.GpsStatusFragment
import com.ntcv4tracker.features.performance.PerformanceFragment
import com.ntcv4tracker.features.performance.api.UpdateGpsStatusRepoProvider
import com.ntcv4tracker.features.performance.model.UpdateGpsInputParamsModel
import com.ntcv4tracker.features.performanceAPP.OwnPerformanceFragment
import com.ntcv4tracker.features.performanceAPP.PerformanceAppFragment
import com.ntcv4tracker.features.performanceAPP.allPerformanceFrag
import com.ntcv4tracker.features.permissionList.ViewPermissionFragment
import com.ntcv4tracker.features.photoReg.*
import com.ntcv4tracker.features.privacypolicy.PrivacypolicyWebviewFrag
import com.ntcv4tracker.features.quotation.presentation.*
import com.ntcv4tracker.features.reimbursement.presentation.*
import com.ntcv4tracker.features.report.presentation.*
import com.ntcv4tracker.features.returnsOrder.*
import com.ntcv4tracker.features.settings.presentation.SettingsFragment
import com.ntcv4tracker.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.ntcv4tracker.features.shopdetail.presentation.*
import com.ntcv4tracker.features.shopdetail.presentation.api.EditShopRepoProvider
import com.ntcv4tracker.features.stock.StockDetailsFragment
import com.ntcv4tracker.features.stock.StockListFragment
import com.ntcv4tracker.features.stockAddCurrentStock.AddShopStockFragment
import com.ntcv4tracker.features.stockAddCurrentStock.UpdateShopStockFragment
import com.ntcv4tracker.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.ntcv4tracker.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.ntcv4tracker.features.stockCompetetorStock.AddCompetetorStockFragment
import com.ntcv4tracker.features.stockCompetetorStock.CompetetorStockFragment
import com.ntcv4tracker.features.stockCompetetorStock.ViewComStockProductDetails
import com.ntcv4tracker.features.survey.SurveyFrag
import com.ntcv4tracker.features.survey.SurveyViewDtlsFrag
import com.ntcv4tracker.features.survey.SurveyViewFrag
import com.ntcv4tracker.features.task.presentation.AddTaskFragment
import com.ntcv4tracker.features.task.presentation.CalenderTaskFragment
import com.ntcv4tracker.features.task.presentation.EditTaskFragment
import com.ntcv4tracker.features.task.presentation.TaskListFragment
import com.ntcv4tracker.features.taskManagement.TaskManagementFrag
import com.ntcv4tracker.features.taskManagement.ViewTaskManagementFrag
import com.ntcv4tracker.features.timesheet.presentation.AddTimeSheetFragment
import com.ntcv4tracker.features.timesheet.presentation.EditTimeSheetFragment
import com.ntcv4tracker.features.timesheet.presentation.TimeSheetListFragment
import com.ntcv4tracker.features.viewAllOrder.CartFragment
import com.ntcv4tracker.features.viewAllOrder.OrderTypeListFragment
import com.ntcv4tracker.features.viewAllOrder.ViewAllOrderListFragment
import com.ntcv4tracker.features.viewAllOrder.ViewCartFragment
import com.ntcv4tracker.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.ntcv4tracker.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.ntcv4tracker.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
...
import com.ntcv4tracker.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.ntcv4tracker.features.viewPPDDStock.ViewOutstandingFragment
import com.ntcv4tracker.features.viewPPDDStock.ViewPPDDListFragment
import com.ntcv4tracker.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.ntcv4tracker.features.viewPPDDStock.ViewStockFragment
import com.ntcv4tracker.features.weather.presentation.WeatherFragment
import com.ntcv4tracker.mappackage.MapActivity
import com.ntcv4tracker.mappackage.MapActivityWithoutPath
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xntcv4trackerlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xntcv4trackerlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xntcv4trackerlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xntcv4trackerlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
