package com.ntcv4tracker.features.logoutsync.presentation
...
import com.ntcv4tracker.CustomConstants
...
import com.ntcv4tracker.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.ntcv4tracker.features.billing.api.AddBillingRepoProvider
import com.ntcv4tracker.features.billing.model.AddBillingInputParamsModel
...
import com.ntcv4tracker.features.dashboard.presentation.ReasonDialog
...
import com.ntcv4tracker.features.document.model.AddEditDocumentInputParams
import com.ntcv4tracker.features.document.model.DocumentAttachmentModel
...
import com.ntcv4tracker.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.ntcv4tracker.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.ntcv4tracker.features.orderhistory.model.*
...
import com.ntcv4tracker.features.quotation.model.AddQuotInputModel
import com.ntcv4tracker.features.shopdetail.presentation.api.EditShopRepoProvider
import com.ntcv4tracker.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.ntcv4tracker.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.ntcv4tracker.features.stock.api.StockRepositoryProvider
import com.ntcv4tracker.features.stock.model.AddStockInputParamsModel
import com.ntcv4tracker.features.stockAddCurrentStock.AddShopStockFragment
import com.ntcv4tracker.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.ntcv4tracker.features.timesheet.model.AddTimeSheetInputModel
import com.ntcv4tracker.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.ntcv4tracker.features.viewAllOrder.model.AddOrderInputParamsModel
import com.ntcv4tracker.features.viewAllOrder.model.AddOrderInputProductList
import com.ntcv4tracker.mappackage.SendBrod
import com.ntcv4tracker.widgets.AppCustomTextView
import com.ntcv4tracker.MonitorService
import com.ntcv4tracker.MySingleton
...
import com.ntcv4tracker.features.addshop.presentation.ShopExtraContactReq
...
import com.ntcv4tracker.features.login.model.GetConcurrentUserResponse
import com.ntcv4tracker.features.login.model.WhatsappApiData
import com.ntcv4tracker.features.performance.model.Gps_status_list
import com.ntcv4tracker.features.performance.model.UpdateGpsInputListParamsModel
import com.ntcv4tracker.features.returnsOrder.ReturnProductList
import com.ntcv4tracker.features.returnsOrder.ReturnRequest
import com.ntcv4tracker.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xntcv4trackerlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xntcv4trackerlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xntcv4trackerlogsample/log.zip").path);
