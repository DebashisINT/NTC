package com.ntcv4tracker.features.location
...
import com.ntcv4tracker.MonitorBroadcast
import com.ntcv4tracker.MultiFun
import com.ntcv4tracker.R
import com.ntcv4tracker.app.*
import com.ntcv4tracker.app.Pref.tempDistance
import com.ntcv4tracker.app.domain.*
import com.ntcv4tracker.app.types.FragType
import com.ntcv4tracker.app.utils.AppUtils
import com.ntcv4tracker.app.utils.AppUtils.Companion.getDateTimeFromTimeStamp
import com.ntcv4tracker.app.utils.AppUtils.Companion.isLocationActivityUpdating
import com.ntcv4tracker.app.utils.FTStorageUtils
import com.ntcv4tracker.app.utils.NotificationUtils
import com.ntcv4tracker.base.BaseResponse
import com.ntcv4tracker.base.presentation.BaseActivity
import com.ntcv4tracker.base.presentation.BaseActivity.Companion.isMeetingUpdating
import com.ntcv4tracker.base.presentation.BaseActivity.Companion.isShopActivityUpdating
import com.ntcv4tracker.features.addshop.api.AddShopRepositoryProvider
import com.ntcv4tracker.features.addshop.model.AddShopRequestCompetetorImg
...
import com.ntcv4tracker.features.dashboard.presentation.SystemEventReceiver
...
import com.ntcv4tracker.features.gpsstatus.GpsReceiver
import com.ntcv4tracker.features.gpsstatus.LocationCallBack
import com.ntcv4tracker.features.location.LocationWizard.Companion.NEARBY_RADIUS
import com.ntcv4tracker.features.location.api.LocationRepoProvider
import com.ntcv4tracker.features.location.ideallocapi.IdealLocationRepoProvider
...
import com.ntcv4tracker.features.orderhistory.model.LocationUpdateRequest
                ...
                for(k in 0..contToSentL.size-1){
                    ...
                    println("tag_automail_check shopObj : ${shopObj.shop_id}")
                        doAsync {
                            ...
                            MultiFun.autoMailScheduler(shopObj.ownerEmailId,schedulerObj.template_content,shopObj)
                            uiThread {
